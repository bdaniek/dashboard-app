...
export const dashboard = {
  ...
  todos: [
    ...
    { id: '3', title: 'Review analytics report', completed: false, priority: 'high' },
    { id: '4', title: 'Setup API integration', completed: true, priority: 'high' },
    { id: '5', title: 'Update documentation', completed: false, priority: 'low' },
    { id: '6', title: 'Performance optimization', completed: false, priority: 'high' },
    { id: '7', title: 'Test payment gateway', completed: true, priority: 'high' },
    { id: '8', title: 'Update user guides', completed: false, priority: 'medium' },
  ],
  usersBySource: [
